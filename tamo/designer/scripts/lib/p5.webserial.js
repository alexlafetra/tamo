...
//this is refactored to not use anything from p5!
...
class WebSerial {
  ...
  async start() {
    ...
    while (this.port.readable && this.keepReading) {
      ...
      //I added in this try/catch block... no idea if it's helping yet.
      try{
