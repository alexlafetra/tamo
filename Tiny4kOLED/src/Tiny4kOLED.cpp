...
void SSD1306Device::bitmap2x(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, const uint8_t bitmap[]) {
	SSD1306Device::bitmap2x(x0,y0,x1,y1,255,bitmap);
}

//this one i wrote...it's p janky
void SSD1306Device::bitmap2x(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t size, const uint8_t bitmap[]) {
	int8_t width = x1-x0;
	if(width<=0)
		return;
	uint16_t j = 0;
