...
void Tamo::think(){
  ...
  Animation actionSprite(SPRITESTARTX+17,SPRITESTARTY,13,16,dreamAnim_gun,4,SLOW,1);
  moodTime = 500;
...
void Tamo::vibeCheck(){
  ...
  const Mood possibleMoods[9] = {NEUTRAL,HAPPY,ANGRY,SAD,THINKING,TALKING,SOBBING,POOPING,EATING};
  mood = possibleMoods[pseudoRandom(0,10)];
  const Thought possibleThoughts[8] = {LOVE,HEARTBREAK,DEATH,REVENGE,FOOD,SELF,FACE,MUSIC};
  thought = possibleThoughts[pseudoRandom(0,8)];
}